...
Route::group([
    ...
    Route::group(['prefix' => 'management', 'namespace' => 'Management'], function () {
        ...
        Route::group(['prefix' => 'survey-report'], function () {
            ...
            Route::get('{id}/answers',
                ['as' => 'admin.management.surveys.answers.show', 'uses' => 'SurveyAnswersController@show']);
            Route::get('{survey_id}/answers/data',
                [
                    'as' => 'admin.management.surveys.answers.show.data',
                    'uses' => 'SurveyAnswersController@answersData'
                ]);
            Route::post('answers/report',
                ['as' => 'admin.management.surveys.answers.report', 'uses' => 'SurveyAnswersController@report']);

        });
    });

    Route::group(['prefix' => 'docuvault', 'namespace' => 'DocuVault'], function () {
        Route::group(['prefix' => 'appraisal'], function () {
            Route::get('/',
                ['as' => 'admin.docuvault.appraisal.index', 'uses' => 'AppraisalController@index']);
            Route::get('data',
                ['as' => 'admin.docuvault.appraisal.data', 'uses' => 'AppraisalController@data']);
            Route::get('create',
                ['as' => 'admin.docuvault.appraisal.create', 'uses' => 'AppraisalController@create']);
            Route::post('store',
                ['as' => 'admin.docuvault.appraisal.store', 'uses' => 'AppraisalController@store']);
            Route::get('{id}/edit',
                ['as' => 'admin.docuvault.appraisal.edit', 'uses' => 'AppraisalController@edit']);
            Route::patch('{id}',
                ['as' => 'admin.docuvault.appraisal.update', 'uses' => 'AppraisalController@update']);
            Route::get('{appraisal}',
                ['as' => 'admin.docuvault.appraisal.delete', 'uses' => 'AppraisalController@delete']);
        });
    });
    Route::group(['prefix' => 'lenders', 'namespace' => 'Lenders'], function () {
        Route::group(['prefix' => 'exclusionary'], function () {
            Route::get('/', ['as' => 'admin.lenders.exclusionary', 'uses' => 'ExclusionaryController@index']);
            Route::get('data',
                ['as' => 'admin.lenders.exclusionary.data', 'uses' => 'ExclusionaryController@exclusionaryData']);
            Route::get('licenses/data',
                ['as' => 'admin.lenders.licenses.data', 'uses' => 'ExclusionaryController@licensesData']);
        });
    });
    ...
    Route::group(['prefix' => 'geo', 'namespace' => 'Geo'], function () {
        Route::group(['prefix' => 'address'], function () {
            ...
            Route::get(
                'data',
                [
                    'as' => 'admin.geo.address.data',
                    'uses' => 'AddressGeoCodeController@geoCodeData'
                ]
            );
            Route::any(
                'create/{addressGeoCode?}',
                [
                    'as' => 'admin.geo.address.create',
                    'uses' => 'AddressGeoCodeController@geoCodeData'
                ]
            );
            Route::any(
                'create_geo_code',
                [
                    'as' => 'admin.geo.address.create_geo_code',
                    'uses' => 'AddressGeoCodeController@createGeoCode'
                ]
            );
            Route::get(
                'refresh/{addressGeoCode}',
                [
                    'as' => 'admin.geo.address.refresh',
                    'uses' => 'AddressGeoCodeController@refreshGeoCode'
                ]
            );
            Route::get(
                'delete/{addressGeoCode}',
                [
                    'as' => 'admin.geo.address.delete',
                    'uses' => 'AddressGeoCodeController@deleteGeoCode'
                ]
            );
        });
    });
